...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Form Edit Visi & Misi</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
                <div class="card card-warning">
                    <div class="card-header">
                        <h3 class="card-title">Form Edit Visi & Misi</h3>
                    </div>

                    <form action="{{ route('vision-and-misions.update', $visionAndMision->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="vision" id="vision"
                                    ...
                                    placeholder="Tulis visi organisasi...">{{ old('vision', $visionAndMision->vision) }}</textarea>
                                @error('vision')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="mision" id="mision"
                                    ...
                                    placeholder="Tulis misi organisasi...">{{ old('mision', $visionAndMision->mision) }}</textarea>
                                @error('mision')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
